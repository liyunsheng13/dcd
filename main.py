...
def main():
    ...
    if args.arch.split('_')[0] == 'mobilenetv3':
        model = models.__dict__[args.arch](width_mult=args.width_mult, dropout=args.dropout, mode=args.mode, fc_squeeze=args.fc_squeeze)
    elif args.arch.split('_')[0] == 'mobilenetv2':
        model = models.__dict__[args.arch](width_mult=args.width_mult, dropout=args.dropout, fc_squeeze=args.fc_squeeze)
    else:
